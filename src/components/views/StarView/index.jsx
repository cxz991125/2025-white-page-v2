        ...
        <div className="star-page">
          <div className="w-full">
           ...
           <Wrapper
            ...
            bannerOptions={{ src: imgPath("title1.png"), w: 2.75, h: 0.25, align: 'center' }}
          >
          ...
          <Wrapper
            ...
            remark="注：代表作选取明星近1～2年在播的主演作品中播映指数或票房最高的作品。</br>注：综合热度是明星评价的综合指标，由明星的专业热度、关注热度、预测热度和带货力加权计算获得。"
            bannerOptions={{ src: imgPath("title2.png"), w: 2.36, h: 0.25, align: 'center' }}
          >
          ...
          <Wrapper
            ...
            bannerOptions={{ src: imgPath("title3.png"), w: 2.37, h: 0.61, align: 'center' }}
          >
          ...
          <Wrapper
            ...
            bannerOptions={{ src: imgPath("title4.png"), w: 2.89, h: 0.25, align: 'center' }}
          >
          ...
          <Wrapper
            ...
            bannerOptions={{ src: imgPath("title5.png"), w: 2.09, h: 0.61, align: 'center' }}
          >
          <ContentList data={dataList[4]}></ContentList>
          </Wrapper>
           <Wrapper
            remark="注：KOL热度指数基于KOL在全网的声量、互动量、粉丝规模加权计算得出。"
            bgImg={<ImgComponent className="w-full top-[-180px]" index="6"></ImgComponent>}
            headerTitle="2025年KOL热度指数TOP10"
            bannerOptions={{ src: imgPath("title6.png"), w: 2.97, h: 0.61, align: 'center' }}
          >
          <ContentList data={dataList[5]}></ContentList>
          </Wrapper>
            <Wrapper
            remark="注：短剧演员热度指数基于短剧演员在全网的声量、互动量、粉丝规模及作品播放量/播放热度加权计算得出。"
            bgImg={<ImgComponent className="w-full top-[-180px]" index="6"></ImgComponent>}
            headerTitle="2025年短剧演员热度指数TOP10"
            bannerOptions={{ src: imgPath("title7.png"), w: 2.63, h: 0.25, align: 'center' }}
          >
          <ContentList data={dataList[6]}></ContentList>
            ...
            bannerOptions={{ src: imgPath("title8.png"), w: 2.8, h: 0., align: 'center' }}
          >
